...
const TodoList = () => {
    ...
    const getAllTodos = async () => {
        try {
            const response = await axios.get('https://to-do-list-mern-backend-ed0u.onrender.com/todolist/getall');
    ...
    const handleDelete = async (id) => {
        try{
            const result = await axios.delete(`https://to-do-list-mern-backend-ed0u.onrender.com/todolist/deleteToDo/${id}`);
        ...
        const handleUpdate = async () => {
            ...
            try{
                const result = await axios.put(`https://to-do-list-mern-backend-ed0u.onrender.com/todolist/updateToDo/${currentTodo._id}`, {
